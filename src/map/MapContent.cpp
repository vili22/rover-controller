...
MapContent::MapContent(QWidget *parent) :
		QOpenGLWidget(parent), cameraPosition(5, 2, 10), horizontalAngle(3.14f), verticalAngle(
				0.0f), nPathPoints(0), nMaxPathPoints(1e4) {
